...
class KitchenTableSceneCfg(InteractiveSceneCfg):
    ...
    mac_n_cheese_on_table = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Samples/NvBlox/mindmap/mug_in_drawer/assets/mac_n_cheese_box.usd",
            scale=(1.0, 1.0, 1.0),
        ),
    )
    tomato_soup_on_table = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Samples/NvBlox/mindmap/mug_in_drawer/assets/tomato_soup.usd",
            scale=(1.0, 1.0, 1.0),
        ),
    )
    ...
    mug1_in_drawer = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            ...
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Samples/NvBlox/mindmap/mug_in_drawer/assets/mug1_in_drawer.usd",
    ...
    mug2_in_drawer = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Samples/NvBlox/mindmap/mug_in_drawer/assets/mug2_in_drawer.usd",
            scale=(0.0125, 0.0125, 0.0125),
        ),
    )
    sugar_box_in_drawer = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Samples/NvBlox/mindmap/mug_in_drawer/assets/sugar_box.usd",
            scale=(1.0, 1.0, 1.0),
        ),
    )
    pudding_box_in_drawer = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Samples/NvBlox/mindmap/mug_in_drawer/assets/pudding_box.usd",
            scale=(1.0, 1.0, 1.0),
        ),
    )
    gelatin_box_in_drawer = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Samples/NvBlox/mindmap/mug_in_drawer/assets/gelatin_box.usd",
            scale=(1.0, 1.0, 1.0),
        ),
    )
